...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://deepsightimaging.ai", "https://deepsightimaging.onrender.com"],
...
async def serve_frontend():
    ...
    if frontend_path.exists():
        ...
        return {"message": "DeepSight Imaging AI API", "status": "running", "frontend": "not found"}
